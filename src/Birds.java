...
public class Birds extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("BIRD BREEDS");

        jPanel3.setBackground(new java.awt.Color(102, 102, 255));
        jPanel3.setLayout(new java.awt.GridLayout(0, 1, 0, 25));

        jButton1.setBackground(new java.awt.Color(153, 255, 153));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lovebird.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/finch.png"))); // NOI18N
        jPanel3.add(jButton2);

        jButton3.setBackground(new java.awt.Color(153, 255, 153));
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/parrot.png"))); // NOI18N
        jPanel3.add(jButton3);

        jButton4.setBackground(new java.awt.Color(153, 255, 153));
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/animal.png"))); // NOI18N
        jPanel3.add(jButton4);

        jButton5.setBackground(new java.awt.Color(153, 255, 153));
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/peace.png"))); // NOI18N
        jPanel3.add(jButton5);

        jButton6.setBackground(new java.awt.Color(153, 255, 153));
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/macaw.png"))); // NOI18N
        ...
        jTextField2.setText("Pet ID : 13135");
        jPanel4.add(jTextField2);

        jTextField3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jTextField3.setText("Price  :  ₱ 5500");
        ...
        jTextField5.setText("Pet ID : 99686");
        jPanel5.add(jTextField5);

        jTextField6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jTextField6.setText("Price  :  ₱ 10,000");
        ...
        jTextField9.setText("Pet ID : 65887");
        ...
        jTextField10.setText("BUDGERIGAR");
        ...
        jTextField18.setText("Pet ID : 25635");
...
//====================================================================================================================================
            ...
            // Predefined prices
            String[] birdBreeds = {"Lovebirds", "Finch", "Parrot", "Budgerigar", "Dove", "Macaw"};
            String[] genders = {"Male", "Female"};
            double[] prices = {5500d, 10000d, 6000d, 8000d, 6000d, 8000d}; // Prices array

            boolean validBreed = false; // Set Default if Breed is valid to false

            for (int i = 0; i < birdBreeds.length; i++) { // Iterate through all the arrays
                if (breedInput.equalsIgnoreCase(birdBreeds[i])) { // Match the text field to the indexes of the array
                    validBreed = true;
                      
                    int[] petIDs = {13135, 99686, 65887, 77833, 15158, 25635};
