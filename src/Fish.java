...
public class Fish extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("FISH BREEDS");

        jPanel3.setBackground(new java.awt.Color(102, 102, 255));
        jPanel3.setLayout(new java.awt.GridLayout(0, 1, 0, 25));

        jButton1.setBackground(new java.awt.Color(153, 255, 153));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fish.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/carp.png"))); // NOI18N
        jPanel3.add(jButton2);

        jButton3.setBackground(new java.awt.Color(153, 255, 153));
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/black-moor.png"))); // NOI18N
        jPanel3.add(jButton3);

        jButton4.setBackground(new java.awt.Color(153, 255, 153));
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/clownfish.png"))); // NOI18N
        jPanel3.add(jButton4);

        jButton5.setBackground(new java.awt.Color(153, 255, 153));
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tiger.png"))); // NOI18N
        jPanel3.add(jButton5);

        jButton6.setBackground(new java.awt.Color(153, 255, 153));
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/guppy.png"))); // NOI18N
        ...
        jTextField2.setText("Pet ID : 96968");
        jPanel4.add(jTextField2);

        jTextField3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jTextField3.setText("Price  :  ₱ 4500");
        ...
        jTextField5.setText("Pet ID : 65875");
        ...
        jTextField7.setText("BLACK MOOR");
        ...
        jTextField9.setText("Pet ID : 63589");
        jPanel6.add(jTextField9);

        jTextField8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jTextField8.setText("Price  :  ₱ 4000");
        ...
        jTextField10.setText("CLOWN FISH");
        ...
        jTextField13.setText("TIGER BARBS");
        ...
        jTextField17.setText("Price  :  ₱ 5000");
...
//====================================================================================================================================
            ...
            // Predefined prices
            String[] fishBreeds = {"Goldfish", "Koi", "Black Moor", "Clown Fish", "Tiger Barbs", "Guppy"};
            String[] genders = {"Male", "Female"};
            double[] prices = {4500d, 5000d, 4000d, 6000d, 8000d, 5000d}; // Prices array

            boolean validBreed = false; // Set Default if Breed is valid to false

            for (int i = 0; i < fishBreeds.length; i++) { // Iterate through all the arrays
                if (breedInput.equalsIgnoreCase(fishBreeds[i])) { // Match the text field to the indexes of the array
                    validBreed = true;
                      
                    int[] petIDs = {96968, 65875, 63589, 23356, 46485, 79895};
...
//====================================================================================================================================
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Petbreedadd your handling code here:
